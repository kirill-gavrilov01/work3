public class Main {
    public static void main(String[] args) {
        ...
        long i = 9233567899L;
        double f = -1.7E+308;
        System.out.println("Значение переменной a с типом Целочисленныемравно " + a);
        System.out.println("Значение переменной b с типом Целочисленныемравно " + b);
        System.out.println("Значение переменной c с типом Целочисленныемравно " + c);
        System.out.println("Значение переменной d с типом Целочисленныемравно " + d);
        System.out.println("Значение переменной i с типом Целочисленныемравно " + i);
        System.out.println("Значение переменной f с типом Целочисленныемравно " + f);
        ...
        int time = 2;
        int bottle = 16;
        int bottleInMinute = (short) (bottle / time);
        int day = (24 * 60);
        int dayWeight =  (bottleInMinute * day);
        int bottlesPer3Days = (1440 * 3);
